    ...
    <div id="miolo_corpo"> 
      ...
      <!-- TITULO PAGINA -->
            <div id="topo_conteudo">
              <div id="titulo_admin">Notícias</div>
            </div>
            <!-- FIM TITULO PAGINA -->
            <table width="100%" border="0" cellspacing="3" cellpadding="5"  id="listagem" style="margin-top:15px;">
            	<tr>
                	<td style="padding-left:20px"><a href="banner/" title="Listar todas as notícias">Todas Categorias</a> | <?php foreach($categorias->result() as $categoria){ ?><a href="conteudo/noticia/categoria/<?php echo $categoria->id;  ?>" title="Listar as notícias da categoria <?php echo $categoria->nome;  ?>"><?php echo $categoria->nome;  ?></a>&nbsp;&nbsp;| <?php } ?></td>
                </tr>
            </table>
        ...
        <div id="topo_conteudo" style="margin-top:35px;">
          <div id="titulo_admin">Noticias Lista - <?php if($categoriaId){ ?> <?php echo $categoriaNome; ?><?php }else{ ?><?php echo $categoriaNome; ?><?php } ?></div>
        </div>
        <!-- FIM TITULO PAGINA -->
        ...
        <table width="100%" border="0" cellspacing="3" cellpadding="5" id="listagem">
          ...
          <tr>
            <td width="80%"><a href="conteudo/detalhes/<?php echo $conteudo->id; ?>"><?php echo $conteudo->titulo; ?></a></td>
